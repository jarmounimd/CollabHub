...
export class GroupsController {
  ...
  @Put(':id')
  async update(@Param('id', ParseMongoIdPipe) id: string, @Body() updateGroupDto: UpdateGroupDto) {
  ...
  async addMember(@Param('id', ParseMongoIdPipe) id: string, @Body() addMemberDto: AddMemberDto) {
